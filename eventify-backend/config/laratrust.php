...
return [
    ...
    */
    'models' => [
        ...
        'role' => \App\Laratrust\Models\Role::class,          // ton modèle Role personnalisé
        'permission' => \App\Laratrust\Models\Permission::class, // ton modèle Permission personnalisé
        'team' => \Laratrust\Models\Team::class, // facultatif si teams = false
    ],
